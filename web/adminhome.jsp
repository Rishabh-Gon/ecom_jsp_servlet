<%-- 
    Document   : adminhome
    Created on : 17 Mar, 2025, 9:18:01 PM
    Author     : RG
--%>
    ...
    <head>
        ...
        response.sendRedirect("index.jsp");
            ...
            if(session.getAttribute("selrid")!=null){
                session.setAttribute("selrid", null);
            }
        %>
        ...
        <div style="display: flex; justify-content: center; align-items: center; font-size: 22px; 
            ...
            <td style="justify-content: center; text-align: justify; padding: 5px; background-color: black; 
                ...
                <a href="adminhome.jsp"style="color: yellow; text-decoration: none;">
                    <b>Active Sellers</b>                    
                </a>
            </td>
            ...
            <div style="margin-bottom: auto; justify-content: center;text-align: justify;padding: 5px;
                ...
                <%
                    ArrayList<Seller> perm_pd=SellerDAO.allPermSeller();
                    if(perm_pd==null){
                %>
                ...
                %>     
                            <tr>
                                ...
                                <td><%=p_mail%></td>
                                <td>
                                    <form action="seller_det.jsp" method="post" style="font-size: 15px;">   
